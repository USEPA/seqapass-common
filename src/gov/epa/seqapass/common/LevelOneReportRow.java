...
public class LevelOneReportRow {

  public LevelOneReportRow() {
  }

  public LevelOneReportRow(String accession, int proteinCount, int speciesTaxId, String taxonomyName,
      String taxonomyLevel, int taxonomyTaxid, String scientificName, String commonName, String commonNameClass,
      String proteinName, int hitLength, int identity, int positives, double evalue, double blastPBitScore,
      String ortholog, double percentSimilarity, double cutoff, int commonDomainCount, String susceptible,
      long endDate2, int updateVersion, int isDup, boolean eukaryote) {
    ...
    this.cutoff = cutoff;
    this.commonDomainCount = commonDomainCount;
  ...
  public LevelOneReportRow(String accession, int proteinCount, int speciesTaxId, String taxonomyName,
      ...
      String proteinName, int hitLength, int identity, int positives, double evalue, double blastPBitScore,
      String ortholog, double percentSimilarity, double cutoff, int commonDomainCount, String susceptible,
      long endDate2, int updateVersion, int isDup, boolean eukaryote, boolean endangered, boolean threatened,
      boolean model, boolean ecotox) {
    this.accession = accession;
    this.proteinCount = proteinCount;
    this.speciesTaxId = speciesTaxId;
    this.taxonomyName = taxonomyName;
  ...
  private List<String> uniprotAcc;

  @SuppressWarnings("unused")
  private boolean partialProtein; // This supports highlighting the
  // queryProtein cell
  @SuppressWarnings("unused")
  private boolean percSimOver; // This supports highlighting the percent
  // similarity cell

  @Override
  public String toString() {
    return "LevelOneReportRow [accession=" + accession + ", proteinCount=" + proteinCount + ", speciesTaxId="
        ...
        + ", commonName=" + commonName + ", proteinName=" + proteinName + "," + ", Hit Length=" + hitLength
        + ", Identity=" + identity + ", Positives=" + positives + ", Evalue=" + evalue + ", blastPBitScore="
        + blastPBitScore + ", ortholog=" + ortholog + ", percentSimilarity=" + percentSimilarity + ", cutoff=" + cutoff
        + ", commonDomainCount=" + commonDomainCount + ", susceptible=" + susceptible + ", endDate=" + endDate
        + ", updateVersion=" + updateVersion + "]";
  }

  public static LevelOneReportRow newInstance(LevelOneReportRow orig) {
    if (orig == null) {
      try {
    ...
    LevelOneReportRow copy = new LevelOneReportRow();
    ...
    copy.setPositives(orig.getPositives());
    ...
    copy.setCommonDomainCount(orig.getCommonDomainCount());
    ...
    copy.setUniprotAcc(orig.getUniprotAcc());
    return copy;
  ...
  public int hashCode() {
    ...
    result = prime * result + commonDomainCount;
  ...
  public boolean equals(Object obj) {
    ...
    LevelOneReportRow other = (LevelOneReportRow) obj;
    if (accession == null) {
  ...
  public boolean fullEquals(Object obj) {
    ...
    if (commonDomainCount != other.commonDomainCount) {
      // System.out.println("commonDomainCount differs");
      return false;
    }
    if (susceptible == null) {
  ...
  public int getCommonDomainCount() {
    return commonDomainCount;
  }

  public void setCommonDomainCount(int commonDomainCount) {
    this.commonDomainCount = commonDomainCount;
  }
